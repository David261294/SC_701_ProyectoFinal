...
namespace FE.W.Controllers
{
    public class EventosController : Controller
    {
        ...
        public EventosController(DBDentistaContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdEvento,DíaEvento,MesEvento,AñoEvento,DetallesEvento")] Eventos eventos)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdEvento,DíaEvento,MesEvento,AñoEvento,DetallesEvento")] Eventos eventos)
        {
